...
≤-Bot-≡ (≤-step {.Act} {.(Bot Act)} {.(Top Act)} ↝-Act l) = refl
≤-Bot-≡ (≤-step {.(Seq P Q)} {.(Bot (Seq P Q))} {.(Seqₗ (Bot P) Q)} (↝-Seq₀ P Q) l) = refl
≤-Bot-≡ (≤-step {.(Seq _ Q)} {.(Seqₗ _ Q)} {.(Seqₗ _ Q)} (↝-Seqₗ {P} {p} {q} r Q) l) = {!≤-Bot-≡ l!}
-- ≤-Bot-≡ l
≤-Bot-≡ (≤-step {.(Seq P Q)} {.(Seqₗ (Top P) Q)} {.(Seqᵣ P (Bot Q))} (↝-Seqₘ P Q) l) = {!!}
≤-Bot-≡ (≤-step {.(Seq P _)} {.(Seqᵣ P _)} {.(Seqᵣ P _)} (↝-Seqᵣ P r) l) = {!!}
≤-Bot-≡ (≤-step {.(Seq P Q)} {.(Seqᵣ P (Top Q))} {.(Top (Seq P Q))} (↝-Seq₁ P Q) l) = {!!}
≤-Bot-≡ (≤-refl .(Bot _)) = refl
-- ≤-Bot-≡ p (≤-step ())
